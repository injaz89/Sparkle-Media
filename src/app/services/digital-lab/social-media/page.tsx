            ...
            <div className="lg:col-span-3 space-y-12 max-w-[1100px] w-full">
              ...
              <div className="space-y-6">
                ...
                <motion.div
                  ...
                  className="border-l-4 border-secondary pl-6 space-y-4 pt-6 border-t border-primary/10"
                >
                    ...
                    <div className="space-y-0 divide-y" style={{ borderColor: "rgba(0,212,255,0.1)" }}>
                      {results.map((result, i) => (
                        ...
                        >
                          ...
                          <p className="text-gray-750 font-light leading-relaxed relative z-10">{result.label}</p>
                        </motion.div>
                      ))}
                    </div>
                  </div>
              ...
              {/* ── Our Approach ── */}
              <section className="bg-white border-t border-b border-primary/15 py-8">
                <div>
                      ...
                      {approach.map((step, i) => (
                        ...
                        >
                          ...
                          <div className="flex-1 relative overflow-hidden group">
                            ...
                            <p className="text-gray-650 font-light leading-relaxed">{step.desc}</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-650 font-light leading-relaxed mb-6">
                ...
                <div className="space-y-0 divide-y" style={{ borderColor: "rgba(0,212,255,0.1)" }}>
                  {businessBenefits.map((benefit, i) => (
                    ...
                    >
                      ...
                      <p className="text-gray-750 font-light relative z-10">{benefit}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
