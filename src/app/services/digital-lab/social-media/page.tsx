  ...
  return (
    <>
      ...
      <main className="pt-32 pb-24 bg-bg min-h-screen relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto space-y-12 w-full mt-8">
            ...
            <div className="space-y-6 text-center">
              ...
              <motion.h1
                ...
                className="text-5xl md:text-6xl lg:text-7xl font-bold text-navy mb-6 leading-[1.05] text-center"
              >
                Social Media{" "}
              ...
              <motion.h2
                ...
                className="text-2xl md:text-3xl font-light text-navy/80 mb-6 leading-snug text-center"
              >
              ...
              <div className="flex justify-center">
                <MotionLink
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-secondary text-white font-semibold hover:bg-primary transition-colors mb-8"
                >
              ...
              <motion.div
                ...
                className="border-l-4 border-secondary pl-6 space-y-4 pt-6 border-t border-primary/10 text-left"
              >
              ...
              <div>
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-start">
                  <div>
                    ...
                    <p className="text-gray-655 font-light leading-relaxed mb-8">
                  ...
                  <div className="space-y-0 divide-y" style={{ borderColor: "rgba(0,212,255,0.1)" }}>
                    {results.map((result, i) => (
                      ...
                      >
                        ...
                        <p className="text-gray-755 font-light leading-relaxed relative z-10">{result.label}</p>
                      </motion.div>
                    ))}
                  </div>
                </div>
            ...
            {/* ── Our Approach ── */}
            <section className="border-t border-b border-primary/15 py-8">
              <div>
                    ...
                    {approach.map((step, i) => (
                      ...
                      >
                        ...
                        <div className="flex-1 relative overflow-hidden group">
                          ...
                          <p className="text-gray-655 font-light leading-relaxed">{step.desc}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
        ...
        {/* ── Why Invest (Outside Grid, Full Width) ── */}
        <section className="bg-navy py-12 px-6 relative overflow-hidden mb-12">
        ...
        {/* ── What We Can Do (Moved Outside Grid, Full Width) ── */}
        <section className="bg-navy py-12 px-6 relative overflow-hidden mb-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-14">
        ...
        {/* ── Why Choose Sparkle (Moved Outside Grid, Full Width) ── */}
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-655 font-light leading-relaxed mb-6">
                ...
                <p className="text-gray-655 font-light leading-relaxed mb-10">
                ...
                <div className="space-y-0 divide-y" style={{ borderColor: "rgba(0,212,255,0.1)" }}>
                  {businessBenefits.map((benefit, i) => (
                    ...
                    >
                      ...
                      <p className="text-gray-755 font-light relative z-10">{benefit}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
