  ...
  return (
    <>
      ...
      <main className="pt-32 pb-24 bg-bg min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="border-l-4 border-secondary pl-6">
                ...
                <p className="text-lg text-gray-700 font-light leading-relaxed mt-3">
              ...
              <div className="bg-white border border-primary/20 p-6 space-y-3 shadow-md">
                ...
                <p className="text-secondary font-semibold text-sm pt-2 border-t border-gray-200 mt-4">
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-16 mb-24">
          {packages.map((pkg) => (
            <motion.div
              ...
              className="bg-white border border-primary/20 hover:border-primary p-8 md:p-12 shadow-xl shadow-sky-100/60 hover:shadow-2xl transition-all duration-300 relative overflow-hidden flex flex-col lg:flex-row gap-12"
            >
              {/* Accent bar */}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white border border-primary/20 p-12 text-center relative overflow-hidden shadow-xl"
          >
        ...
        {/* Benefits Section */}
        <div className="bg-bg border-t border-primary/20 py-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <span className="text-xs font-bold tracking-widest text-secondary uppercase">Why It Works</span>
              ...
              {benefits.map((benefit, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white p-10 border border-primary/20 hover:border-primary hover:shadow-xl hover:shadow-sky-100/60 transition-all duration-300 relative overflow-hidden group"
                  >
                    ...
                    <div className="w-16 h-16 bg-white border border-primary/20 flex items-center justify-center text-secondary mb-8 group-hover:scale-110 transition-transform duration-300">
