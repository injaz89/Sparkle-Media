          ...
          <div className="max-w-5xl mx-auto space-y-12 w-full mt-8">
            ...
            <div className="space-y-6 text-center">
              ...
              >
                ...
                <p className="text-lg text-navy font-semibold text-center">
              ...
              <div className="relative z-10">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-start">
                  ...
                  >
                    ...
                    <p className="text-gray-755 font-light leading-relaxed mb-4">
                    ...
                    <p className="text-gray-755 font-light leading-relaxed">
                    ...
                    {whatsappServices.map((item, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-gray-655 text-sm font-light">{item.text}</span>
                        </motion.div>
                      );
                    })}
                  </motion.div>
              ...
              <div>
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-start">
                  ...
                  >
                    ...
                    <p className="text-gray-755 font-light leading-relaxed mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-8">
                      {emailServices.map((service, i) => (
                        <div key={i} className="flex items-center gap-2">
                          ...
                          <span className="text-gray-655 text-sm font-light">{service}</span>
                        </div>
                      ))}
                    </div>
              ...
              <div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-655 font-light max-w-xl mx-auto mb-8 leading-relaxed">
