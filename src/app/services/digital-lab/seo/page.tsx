            ...
            <div className="lg:col-span-3 space-y-12 max-w-[1100px] w-full">
              ...
              <div className="space-y-6">
                ...
                <motion.h3
                  ...
                  className="text-2xl font-light leading-relaxed text-navy-light"
                  style={{ color: "#334155" }}
                >
                ...
                >
                  <p className="text-lg font-light text-gray-500" style={{ color: "#64748b" }}>
              ...
              {/* Stats Section */}
              <div className="py-4 bg-white/40 backdrop-blur-sm border border-primary/10 p-6 shadow-sm">
                <SeoCounters />
              </div>

              {/* Full SEO Section */}
              <section className="py-8 relative z-10 border-t border-primary/20">
                <div>
                  <div className="mb-12">
                    <h2
                      className="text-4xl font-bold text-navy leading-tight mb-4"
                    >
                      We do full-on SEO for your website
                    </h2>
                    <p className="text-lg font-light text-gray-500" style={{ color: "#64748b" }}>Or pick the one you like!</p>
                  </div>
                      ...
                      {fullSeoFeatures.map((item, i) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className="group flex gap-8 py-8 sm:pl-14 relative overflow-hidden"
                          >
                            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                              style={{ background: "linear-gradient(90deg, rgba(0,212,255,0.04) 0%, transparent 60%)" }} />
                            
                            {/* Circle number */}
                            <div
                              className="hidden sm:flex absolute left-0 top-8 w-10 h-10 rounded-full items-center justify-center flex-shrink-0 border-2 transition-all duration-300 group-hover:scale-110 bg-white"
                              style={{
                            ...
                            <div className="flex-1 relative z-10">
                              <span className="sm:hidden text-xs font-bold block mb-2" style={{ color: "#00d4ff" }}>
                                {numStr}
                              </span>
                              <h3
