      ...
      <main className="bg-white min-h-screen">
              ...
              >
                ...
                <div className="border-l-2 border-cyan-400 pl-6 space-y-4">
                  <p className="text-gray-300 font-light leading-relaxed">
                    ...
                    <span className="text-white font-semibold">They need more customers.</span>
                  </p>
                  <p className="text-gray-300 font-light leading-relaxed">
              ...
              >
                ...
                <div className="space-y-3">
                  {results.map((r, i) => (
                    <motion.div
                      key={i}
                      className="flex items-center justify-between p-4 bg-white/5 border border-white/10 hover:border-cyan-400/30 transition-colors"
                ...
                <p className="text-gray-500 text-xs font-light mt-4 italic">
        ...
        <section className="py-20 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <motion.span
                className="text-xs font-bold text-cyan-500 uppercase tracking-widest"
                initial={{ opacity: 0 }}
              ...
              {approaches.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white p-10 border border-gray-100 hover:border-cyan-200 hover:shadow-2xl hover:shadow-cyan-900/5 transition-all duration-300 group relative overflow-hidden"
                  >
                    ...
                    <div className="w-14 h-14 bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-100 flex items-center justify-center text-cyan-600 mb-8 group-hover:scale-110 transition-transform duration-300">
        ...
        <section className="py-24 bg-navy relative overflow-hidden">
          <div
            className="absolute inset-0 opacity-[0.04] pointer-events-none"
            style={{
              backgroundImage: "radial-gradient(circle at 30% 50%, #00B4DB 0%, transparent 60%)",
            }}
          />
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              {platforms.map((platform, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.1 }}
                    className="bg-white/5 border border-white/10 hover:border-cyan-400/30 p-8 transition-all duration-300 hover:bg-white/8"
                  >
                    ...
                    <p className="text-gray-400 font-light text-sm leading-relaxed">{platform.desc}</p>
                  </motion.div>
                );
              })}
            </div>
              ...
              <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {capabilities.map((cap, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 hover:border-cyan-200 hover:bg-cyan-50/50 transition-all group"
                  >
                    <CheckCircle2 className="w-5 h-5 text-cyan-400 flex-shrink-0 group-hover:scale-110 transition-transform" />
                    <span className="text-navy font-medium text-sm">{cap}</span>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="border-l-2 border-cyan-400 pl-6 space-y-3">
                  ...
                  <p className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">
                    We optimize for outcomes.
                  </p>
                </div>
                <p className="text-gray-500 font-light mt-6 mb-4">Our focus is on helping businesses:</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                  {outcomes.map((item, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <span className="w-5 h-5 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center flex-shrink-0">
