            ...
            <div className="lg:col-span-3 space-y-12 max-w-[1100px] w-full">
              ...
              <div className="space-y-6">
                <motion.div
                  ...
                  className="w-20 h-20 rounded-[2rem] rotate-3 flex items-center justify-center text-white mb-4"
                  style={{ background: "linear-gradient(135deg, #00d4ff, #7c3aed)", boxShadow: "0 20px 60px rgba(0,212,255,0.4)" }}
                >
                  <Gauge className="w-10 h-10 -rotate-3" />
                </motion.div>
                ...
                <motion.h1 
                  ...
                  className="text-5xl md:text-6xl lg:text-7xl font-bold text-navy leading-[1.1] tracking-tight"
                ...
                <motion.h3 
                  ...
                  className="text-2xl font-light leading-relaxed text-gray-500"
                  style={{ color: "#64748b" }}
                >
