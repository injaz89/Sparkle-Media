      ...
      <main className="pt-32 pb-24 bg-bg min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-24 text-center relative z-10">
          <motion.div
            ...
            className="w-24 h-24 bg-white border border-primary/20 mx-auto rounded-none flex items-center justify-center text-secondary mb-8"
          >
          ...
          <motion.h3 
            ...
            className="text-2xl text-gray-700 font-light leading-relaxed max-w-3xl mx-auto"
          >
        ...
        <div className="max-w-5xl mx-auto px-6 mb-32 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-primary/20 rounded-none blur-[100px] opacity-60 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-white p-10 border border-primary/20 shadow-xl hover:border-primary transition-colors"
            >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="bg-secondary p-10 text-white shadow-xl shadow-sky-200/50 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary rounded-none blur-[60px] opacity-40" />
              <p className="text-white font-light text-lg leading-relaxed relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 bg-bg border-t border-primary/20 py-24">
            ...
            {videoTypes.map((type, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white border border-primary/20 hover:border-primary shadow-xl shadow-sky-100/60 hover:shadow-2xl p-2 transition-all duration-300 group"
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    {/* Simulated 16:9 Video Thumbnail */}
                    <div className="w-full md:w-1/3 aspect-[16/9] bg-bg border border-primary/20 relative overflow-hidden flex-shrink-0">
                      <div className="absolute inset-0 bg-primary/5 group-hover:bg-primary/0 transition-colors duration-500" />
                      <div className="absolute inset-0 flex items-center justify-center">
                        <Icon className="w-16 h-16 text-primary group-hover:text-secondary group-hover:scale-125 transition-all duration-500" />
                      </div>
                    </div>
