    ...
    <>
      ...
      <main className="pt-32 pb-24 bg-bg min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-24 relative z-10">
          <div className="flex flex-col items-center text-center">
            <motion.div
              ...
              className="w-24 h-24 bg-gradient-to-tr from-primary to-secondary rounded-[2rem] rotate-3 flex items-center justify-center text-white mb-8 shadow-2xl shadow-primary/30"
            >
        ...
        <div className="max-w-5xl mx-auto px-6 mb-32 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-full bg-primary/20 rounded-none blur-[100px] opacity-60 pointer-events-none" />
          
          <motion.div 
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white p-10 md:p-16 border border-primary/20 shadow-xl shadow-sky-100/60 relative z-10 space-y-8 text-lg font-light text-gray-650 leading-loose"
          >
            <p>
            ...
            <p className="border-l-4 border-secondary pl-6 text-navy font-semibold">
            ...
            {graphicTypes.map((type, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white border border-primary/20 p-10 hover:border-primary hover:shadow-xl hover:shadow-sky-100/60 transition-all duration-300 group overflow-hidden relative"
                >
