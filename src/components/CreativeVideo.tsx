...
export function CreativeVideo() {
  return (
    <section className="py-24 bg-bg border-t border-primary/20 text-navy overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 mb-16 relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 flex items-center">
          <PlayCircle className="w-10 h-10 mr-4 text-secondary" />
          Video Production
        </h2>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-8 z-20">
            <h3 className="text-3xl font-bold text-white mb-2">Full Scale Video</h3>
            <p className="text-blue-100 font-light">High-end commercial films with professional crews, lighting, and heavy editing.</p>
          </div>
        </motion.div>
        ...
        >
          {/* Simulated Video BG Overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-secondary/80 to-transparent opacity-80 z-10" />
          ...
          <div className="absolute top-8 right-8 z-20">
            ...
            <motion.div 
              className="bg-secondary text-white text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-none flex items-center shadow-lg shadow-secondary/20"
          ...
          <div className="absolute bottom-0 left-0 p-8 z-20">
            <h3 className="text-3xl font-bold text-white mb-2">Mobile First</h3>
            <p className="text-blue-100 font-light">Fast-paced, highly engaging vertical content for TikTok, Reels, and Shorts.</p>
          </div>
        </motion.div>
